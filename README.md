...
* **Core Methodology:** Self-studied and applied an advanced statistical modeling framework (implemented during undergraduate final year thesis at YUECO) to analyze 6 years of monthly transactional data extracted from the Central Statistical Organization (CSO).
...
* Time-Series Forecasting, Regression Analysis, Error Benchmarking, Data Transformation & Wrangling.
